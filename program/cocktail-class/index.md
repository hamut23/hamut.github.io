---
layout: default
title: 연남동 전통주 칵테일 클래스
description: "서울 연남동 하뭇에서 진행하는 전통주 칵테일 원데이 클래스입니다. 다양한 한국 전통주를 맛보고 나만의 칵테일을 직접 만들어보며 우리술과 새로운 취향을 경험할 수 있습니다."
---
...
<section class="hamut-section">
  ...
  <p class="section-lead">
    다양한 한국 전통주를 맛보고 나만의 칵테일을 직접 만들어보며
  ...
  <p>
    연남동에서 특별한 데이트나 새로운 취미를 찾고 있다면,
    전통주를 조금 더 재미있게 경험해볼 수 있는 원데이 클래스입니다.
  </p>

  <p>
    하뭇에서는 전통주를 어렵게 공부하기보다
    직접 맛보고 만들어보면서 자연스럽게 자신의 취향을 발견하는 경험을 중요하게 생각합니다.
  </p>
...
<section class="hamut-section">
  ...
  <p class="section-lead">
    클래스에서는 다양한 종류의 전통주를 직접 맛보고
    각각의 향과 맛을 비교하며 나만의 취향을 찾아봅니다.
  </p>

  <p>
    실제 클래스에서는 막걸리, 청주·약주, 과실주, 증류주 등
    다양한 한국술을 활용합니다.
  </p>

  <p>
    보통 막걸리 1종과 증류주 3종의 술을
    경험하지만, 제공되는 술의 종류와 구성은 일정과 시즌에 따라
    달라질 수 있습니다.
  </p>
  ...
  <div class="program-card">
    ...
    <h3>🍵 청주·약주 · Cheongju & Yakju</h3>
    <p>
      발효한 술을 맑게 걸러낸 우리술로,
      섬세한 향과 깔끔한 맛을 경험할 수 있습니다.
    </p>
...
<section class="hamut-section">
  ...
  <ul class="recommend-list">
    <li>연남동에서 색다른 전통주 체험을 찾는 분</li>
    <li>전통주와 칵테일을 함께 경험해보고 싶은 분</li>
    <li>특별한 데이트나 새로운 취미를 찾는 분</li>
    <li>전통주를 새로운 방식으로 즐겨보고 싶은 분</li>
    <li>한국술을 처음 접해보고 싶은 분</li>
  </ul>
...
<section class="hamut-section">
  ...
  <h2>하뭇의 다른 프로그램도 만나보세요</h2>

  <p class="section-lead">
    하뭇에서는 전통주를 매개로
    다양한 사람과 취향을 만나는 프로그램을 운영하고 있습니다.
  </p>
  ...
  <p>
    하뭇에서 진행하는 모든 프로그램은
    <a href="{{ '/program/' | relative_url }}">하뭇 프로그램 전체 보기</a>에서 확인할 수 있습니다.
  </p>
